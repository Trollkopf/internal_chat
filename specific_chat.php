...
$receiversurname = $_GET['receiver_surname'];

$chats = ChatController::read_specific_chat($userid, $receiverid);
...
<div class="container">
	<div class="row">
		...
		<div class="bg-dark mt-3 p-3 rounded-lg col-9">
			...
			<h3 class="text-white d-flex justify-content-center">Chat with&nbsp;<span style="color:#dd7ff3;">
					<?php echo $receivername . " " . $receiversurname; ?>
				</span>
			</h3>
			...
			<form class="form-horizontal" method="post" action="./router/router.php">
				...
				<input type="hidden" value="<?php echo $receiverid; ?>" name="receiver_id">
				<input type="hidden" value="<?php echo $receivername; ?>" name="receiver_name">
				<input type="hidden" value="<?php echo $receiversurname; ?>" name="receiver_surname">
				...
				<div class="form-group d-flex justify-items-center p-2">
					...
					<div class="col-sm-2 p-2">
						<button type="submit" name="new_specific_msg" value="new_msg"
		...
		<div class="col-sm">
			<div class="overflow-auto bg-dark mt-3 p-3 rounded-lg" id="display_users">
				<form class="form-horizontal" method="post" action="./home.php">
					<button type="submit" name="contact_user" class="btn-block bg-info rounded-lg h p-2 mb-2"
						value="contact_user">
