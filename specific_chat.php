<?php 
	session_start();
		...
		$receiverid = $_POST['receiver_id'];
			...
			$query = ChatController::read_specific_chat($userid, $receiverid);
		?>
					...
					<?php else: ?>
						<div class="d-flex justify-content-start mx-3 mb-1">
							<p class="bg-info rounded-lg p-3">
								<span class="font-weight-bold"><?php echo $q->receiver; ?> :</span>
								<?php echo $q->message; ?>
							</p>
						</div>
					<?php endif; 
